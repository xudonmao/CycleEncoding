...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--image_interval', default=100000000, type=int,
        ...
        # Cycle Encoding: W+ -> W
        self.parser.add_argument('--inverse_progressive_start', type=int, default=650000,
                                 help="The training step to start the inverse progressive training")
        self.parser.add_argument('--inverse_progressive_step_every', type=int, default=4000,
                                 help="Amount of training steps for each inverse progressive step")
        self.parser.add_argument('--delta_norm_lambda_progressive_step_every', type=int, default=10000,
                                 help="Amount of training steps for each lambda progressive step")
